...
const PrivacyPolicy = () => {
  ...
  return (
    <div>
      <div className="p-6 lg:px-20 flex flex-col items-center justify-center">
        <div className="flex flex-row items-center justify-center mb-3">
          <div className="flex items-center justify-center">
            <img src={docImg} alt="doc" className="w-16 md:w-20" />
          </div>
          <div className="flex flex-col font-semibold md:text-xl lg:text-2xl">
            <h1>Terms</h1>
            <h1>
              and Conditions of <span className="text-[#3555ac]"> Usage</span>
            </h1>
          </div>
        </div>
        <div>
          <p className="text-center text-xs md:text-sm md:px-5 lg:px-20 lg:text-base mb-3">
            Please review the Terms of Service below in its entirety for
            important information and legal conditions that apply to your use of
            the Platform for the sharing and viewing of online for mobile
            devices and personal computers.
          </p>
          <div className="flex items-center py-3 mb-1">
            <div className="flex-grow h-px bg-gray-400"></div>
            <div>
              <h1 className="text-gray-400 px-4">Scroll Down</h1>
            </div>
            <div className="flex-grow h-px bg-gray-400"></div>
          </div>
        </div>
        <div className="flex flex-col items-center">
          <div className="intro  text-xs md:text-sm md:px-5 lg:text-base mb-3">
            <p>
          ...
          <div className="user_concent text-xs md:text-sm md:px-5 lg:text-base mb-4">
            <h1 className="font-semibold text-sm md:text-base mb-1">
              USER CONCENT
            </h1>
            <p>
          ...
          <div className="updation text-xs md:text-sm md:px-5 lg:text-base mb-4">
            ...
            <p>
              ...
              Services, a Member agrees to: To provide current, complete, and
              accurate information about himself as prompted to do so by the
              Website. To maintain and update the above information as required
              and submitted by you with the view to maintain the accuracy of the
